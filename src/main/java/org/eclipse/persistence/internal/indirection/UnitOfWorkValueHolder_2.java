 ...
 * @author    Sati
 */
public abstract class UnitOfWorkValueHolder_2<T> extends DatabaseValueHolder_2<T> implements WrappingValueHolder<T> {
    ...
    protected UnitOfWorkValueHolder_2() {
        super();
    }

    protected UnitOfWorkValueHolder_2(ValueHolderInterface<T> attributeValue, Object clone, DatabaseMapping mapping, UnitOfWorkImpl unitOfWork) {
    ...
    protected T instantiateImpl() {
        ...
        Lock lock;
        if (wrappedValueHolder instanceof DatabaseValueHolder_2) {
            lock = ((DatabaseValueHolder_2<T>)wrappedValueHolder).instanceLock;
        } else {
            lock = wrappedValueHolderLock;
        }
        lock.lock();
        try {
            if (this.wrappedValueHolder instanceof DatabaseValueHolder_2) {
                DatabaseValueHolder_2<T> wrapped = (DatabaseValueHolder_2<T>)this.wrappedValueHolder;
    ...
    public boolean isEasilyInstantiated() {
        return this.isInstantiated || ((this.wrappedValueHolder != null)
                && (!(this.wrappedValueHolder instanceof DatabaseValueHolder_2) || ((DatabaseValueHolder_2)this.wrappedValueHolder).isEasilyInstantiated()));
    }
    ...
    public boolean isPessimisticLockingValueHolder() {
        ...
        // this subclass.
        return ((this.wrappedValueHolder != null) && (this.wrappedValueHolder instanceof DatabaseValueHolder_2) && ((DatabaseValueHolder_2)this.wrappedValueHolder).isPessimisticLockingValueHolder());
    }
     ...
     */
    @Override
    public T instantiateForUnitOfWorkValueHolder(UnitOfWorkValueHolder_2<T> unitOfWorkValueHolder) {
    ...
    protected void setWrappedValueHolder(DatabaseValueHolder_2<T> valueHolder) {
