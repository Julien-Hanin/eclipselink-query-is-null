 ...
 * @author    Dorin Sandu
 */
public abstract class DatabaseValueHolder_2<T> implements WeavedAttributeValueHolderInterface<T>, Cloneable, Serializable {
    ...
    public final Lock instanceLock = new ReentrantLock();

    /**
     * Default constructor.
     */
    protected DatabaseValueHolder_2() {
    }
     ...
     */
    public abstract T instantiateForUnitOfWorkValueHolder(UnitOfWorkValueHolder_2<T> unitOfWorkValueHolder);
